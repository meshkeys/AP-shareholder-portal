    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
        ...
        <div style="background: #fff; border: 1px solid #e8e8e8; border-top: none; padding: 24px; border-radius: 0 0 8px 8px;">
          ...
          <p style="font-size: 14px; color: #6b6b6b; line-height: 1.6; margin-bottom: 24px;">
            There is an update on your request with reference number <strong>${referenceNumber}</strong>.
          </p>

          <!-- Status badge -->
          <div style="background: #f8f8f8; border: 1px solid #e8e8e8; border-radius: 8px; padding: 16px; margin-bottom: 24px; text-align: center;">
            <p style="font-size: 12px; color: #6b6b6b; margin-bottom: 6px; text-transform: uppercase; letter-spacing: 1px;">
              Request status
            </p>
          ...
          <!-- Custom message -->
          <div style="background: #f8f8f8; border-left: 3px solid #C0392B; padding: 14px 16px; margin-bottom: 24px; border-radius: 0 8px 8px 0;">
            <p style="font-size: 13px; color: #6b6b6b; margin-bottom: 4px; font-weight: 500;">Message from our team:</p>
          ...
          <p style="font-size: 13px; color: #6b6b6b; line-height: 1.6; margin-bottom: 24px;">
            If you have any questions about your request, please contact us using your reference number.
          </p>

          <hr style="border: none; border-top: 1px solid #f0f0f0; margin-bottom: 16px;" />

          <p style="font-size: 12px; color: #b0b0b0; text-align: center;">
            ShareReg Portal &nbsp;·&nbsp; Shareholder Registry Services<br/>
            <a href="mailto:support@sharereg.ng" style="color: #C0392B;">support@sharereg.ng</a>
          </p>
        </div>
